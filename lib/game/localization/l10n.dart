...
class L10n {
  ...
  static const Map<AppLocale, Map<String, String>> _strings = {
    AppLocale.ru: {
      ...
      'altar_ninja_triple_strike_title': 'Тройной удар',
      'altar_ninja_triple_strike_desc': 'Шанс на третий быстрый удар.',
      'altar_ninja_evasion_strike_title': 'Уклонение-удар',
      'altar_ninja_evasion_strike_desc': 'После уворота следующий удар гарантированно критический.',
    ...
    AppLocale.en: {
      ...
      'altar_ninja_triple_strike_title': 'Triple Strike',
      'altar_ninja_triple_strike_desc': 'Chance to land a third quick hit.',
      'altar_ninja_evasion_strike_title': 'Evasion Strike',
      'altar_ninja_evasion_strike_desc': 'After a dodge, the next hit is guaranteed critical.',
