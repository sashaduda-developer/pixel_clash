  ...
  static Future<void> ensureSeeded(AppDatabase db) async {
    ...
    final rows = <RewardDefinitionsCompanion>[
      ...
      ..._itemVariantsMap(
        source: 'chest',
        id: 'item_glass_blade',
        titleKey: 'chest_glass_blade_title',
        descKey: 'chest_glass_blade_desc',
        iconKey: 'sword',
        common: {'damageDelta': 2, 'critChanceAdd': 0.02, 'maxHpDelta': -6},
        rare: {'damageDelta': 4, 'critChanceAdd': 0.04, 'maxHpDelta': -9},
        epic: {'damageDelta': 6, 'critChanceAdd': 0.06, 'maxHpDelta': -12},
        legendary: {'damageDelta': 8, 'critChanceAdd': 0.08, 'maxHpDelta': -16},
      ),
      ..._itemVariantsMap(
        source: 'chest',
        id: 'item_overheat_sphere',
        titleKey: 'chest_overheat_sphere_title',
        descKey: 'chest_overheat_sphere_desc',
        iconKey: 'bolt',
        common: {
          'attackSpeedPct': 0.10,
          'damageDelta': 1,
      ...
      ..._itemVariantsMap(
        source: 'chest',
        id: 'item_mask_void',
        titleKey: 'chest_mask_void_title',
        descKey: 'chest_mask_void_desc',
        iconKey: 'mask',
        common: {
          'voidProcChance': 0.10,
          'voidDurationSec': 0.20,
          'voidCooldownSec': 9.0,
          'maxHpPct': 0.06,
        },
        rare: {
          'voidProcChance': 0.14,
          'voidDurationSec': 0.25,
          'voidCooldownSec': 8.0,
          'maxHpPct': 0.10,
        },
        epic: {
          'voidProcChance': 0.18,
          'voidDurationSec': 0.30,
          'voidCooldownSec': 7.0,
          'maxHpPct': 0.14,
        },
        legendary: {
          'voidProcChance': 0.24,
          'voidDurationSec': 0.35,
          'voidCooldownSec': 6.0,
          'maxHpPct': 0.18,
        },
      ),
      ..._itemVariantsMap(
        source: 'chest',
        id: 'item_heart_messenger',
        titleKey: 'chest_heart_messenger_title',
        descKey: 'chest_heart_messenger_desc',
        iconKey: 'heart',
        common: {'sprintSpeedPct': 0.25, 'sprintDurationSec': 1.1, 'maxHpDelta': -4},
        rare: {'sprintSpeedPct': 0.30, 'sprintDurationSec': 1.3, 'maxHpDelta': -6},
        epic: {'sprintSpeedPct': 0.35, 'sprintDurationSec': 1.5, 'maxHpDelta': -8},
        legendary: {'sprintSpeedPct': 0.45, 'sprintDurationSec': 1.8, 'maxHpDelta': -12},
      ),
      ..._itemVariantsMap(
        source: 'chest',
